        ...
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-5xl mx-auto mb-24">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpSimple}>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>Born in Tbilisi, Georgia, Levan Mosiashvili is a contemporary abstract artist whose work has been exhibited across Europe and Asia. His paintings are held in private collections in over a dozen countries.</p>
              <p>Trained at the Tbilisi State Academy of Arts, Levan developed a distinctive approach that combines the bold gestural energy of Abstract Expressionism with the rich visual heritage of Georgian and Byzantine art. His use of gold leaf connects to centuries of Georgian artistic tradition while speaking a decisively contemporary language.</p>
              <p>His work explores the tension between structure and chaos, stillness and movement — seeking to capture the moments of transformation that exist just beyond the visible world.</p>
            </div>
          </motion.div>
        </div>

        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpSimple} className="max-w-3xl mx-auto text-center mb-24">
          ...
          <blockquote className="font-serif text-xl md:text-2xl italic text-muted-foreground leading-relaxed">
            "I paint the spaces between things — between light and dark, between the ancient and the new, between what we see and what we feel. The canvas is where these opposites meet, and something unexpected is born."
          </blockquote>
        </motion.section>

        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpSimple} className="mb-24">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed">Located in the historic Vera district of Tbilisi, Levan's studio occupies a converted industrial space flooded with natural light. The high ceilings accommodate his large-scale works, while the surrounding neighborhood provides constant inspiration.</p>
          </div>
        </motion.section>

        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUpSimple} className="max-w-3xl mx-auto">
